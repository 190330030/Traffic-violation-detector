    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite(
                    r"C:\Users\Adithya\PycharmProjects\traffic violation detection\Traffic-Signal-Violation-Detection-System\Detected Images/violation_" + str(
                        dcnt) + ".jpg", cimg)
                dcnt = dcnt + 1
            else:
...
weights_path = r"C:\Users\Adithya\PycharmProjects\traffic violation detection\Traffic-Signal-Violation-Detection-System\yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
